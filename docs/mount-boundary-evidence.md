...
| A nested root the weaker selector would un-clip | `widgets/@task/task-card/widget.tsx:276` |
...
| Where | What it does |
|---|---|
| `widgets/@core/view-group/widget.tsx:142` | `active.render ? active.render() : <Missing/>` |
| `widgets/@core/view-group/widget.tsx:143` | `if (!isStriped && active.render) return body` — the unstriped branch |
...
| Exactly one declares `mounts` | `widgets/@core/view-group/manifest.json` |
