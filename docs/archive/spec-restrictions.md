...
- **A screen that narrows may still take a tile below its floor.** That is deliberate: below
  ...
  a _person's drag_, not the window's width — the moment it bounds the window, row-dropping
  comes back.
...
is the whole complaint about the screenshots. A widget styles its _content_; the kit styles
its _chrome_.
