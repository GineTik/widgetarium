...
:root{--wg-radius-xs:4px;--wg-radius-sm:8px;--wg-radius-base:12px;--wg-radius-lg:16px;--wg-radius-xl:1.5rem;--wg-radius-2xl:2rem;--wg-radius-3xl:2.5rem;--wg-radius-full:999px;--wg-widget-radius-base:1.875rem;--wg-widget-radius-full:999px;--background-primary:#ffffff;--background-primary-alt:#F2F2F2;--background-secondary:#f2f3f5;--background-modifier-hover:#F2F2F2;--background-modifier-active-hover:#EAEAEA;--background-modifier-border:#e0e0e0;--text-normal:#000000;--text-muted:#707070;--text-faint:rgba(0,0,0,0.3);--text-on-accent:#000000;--interactive-accent:#E1FF01;--interactive-accent-hover:#d3f000;--color-green:#147E03;--color-blue:#084CCA;--font-interface:Inter,system-ui,sans-serif;--radius-l:14px}
