...
export { defineManifest, defineProp, migration, verb } from "../../core/src/gateway/manifest";

export type { DataState, Listed } from "../../core/src/gateway/use-data";
export { useData } from "../../core/src/gateway/use-data";
export { action, arrayGateway, canDo, collectionGateway, soloGateway, valueGateway } from "../../core/src/gateway/create";
...
import type { DeclaredPropSpecs } from "../../core/src/gateway/contract";
import type { Manifest, PropsOf } from "../../core/src/gateway/manifest";
import type { VaultRecord } from "../../core/src/gateway/needs";
