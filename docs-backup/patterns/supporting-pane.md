...
a main surface flanked by helpers is _not_ a three-pane drill-down, even though they look alike.

## In a board

A collapsing side box on the right, holding property widgets that read the main region's selection by
